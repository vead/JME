...
public class InputSystem  implements ActionListener, AnalogListener {
	...
	public InputSystem(InputManager inputManager, GameEventSystem gameEventSystem) {
		super();
...
//			String release = "-" + keyMap.get(kt).toString();

			inputManager.addMapping(press, kt);
//			inputManager.addMapping(release, kt);

//			inputManager.addListener(this, press, release);
