...
public class DebugHudAppState extends AbstractAppState {
...
//	private int yOffset = 30;
  ...
  public void initialize(AppStateManager stateManager, Application app) {
    	pho = (PhobosMain)app;
//	DebugHudAppState(BitmapFont guiFont, Node guiNode, int screenWidth) {
		this.guiFont = pho.getGuiFont();
		this.guiNode = pho.getGuiNode();
//		this.screenWidth = pho.getSettings().getWidth();
	...
	// TODO Embarrassing. Just refactor all.
	private void createSelectInfo() {
		...
		selectedInfoTextL2.setColor(color);   
		selectedInfoTextL3.setColor(color);   
		selectedInfoTextL4.setColor(color);
